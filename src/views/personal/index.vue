				...
				<el-card shadow="hover" header="个人信息">
					<div class="personal-user">
						...
						<div class="personal-user-right">
							<el-row>
								<el-col :span="24" class="personal-title mb18">{{ currentTime }}，{{ getUserInfos.username || '匿名' }}，生活变的再糟糕，也不妨碍我变得更好！ </el-col>
								<el-col :span="24">
									<el-row>
										<el-col :xs="24" :sm="8" class="personal-item mb6">
											<div class="personal-item-label">昵称：</div>
											<div class="personal-item-value">{{ getUserInfos.username || '匿名' }}</div>
										</el-col>
								...
								<el-col :span="24">
									<el-row>
										<el-col :xs="24" :sm="8" class="personal-item mb6">
											...
											<div class="personal-item-value">{{ getUserInfos.lastLoginIp || '192.168.1.1' }}</div>
										</el-col>
										<el-col :xs="24" :sm="16" class="personal-item mb6">
											<div class="personal-item-label">登录时间：</div>
											<div class="personal-item-value">{{ parseTime(getUserInfos.lastLoginTime) }}</div>
										</el-col>
									</el-row>
								</el-col>
							</el-row>
					...
					<div class="personal-edit-safe-box">
						<div class="personal-edit-safe-item">
							...
							<div class="personal-edit-safe-item-right">
								<el-button type="text" @click="handler('password',true)">立即修改</el-button>
							</div>
						</div>
					</div>
					<div class="personal-edit-safe-box">
						<div class="personal-edit-safe-item">
							<div class="personal-edit-safe-item-left">
								...
								<div class="personal-edit-safe-item-left-value">如果所属多个角色可更换角色</div>
							</div>
							<div class="personal-edit-safe-item-right">
					...
					<div class="personal-edit-safe-box">
						<div class="personal-edit-safe-item">
							<div class="personal-edit-safe-item-left">
								...
								<div class="personal-edit-safe-item-left-value">如果所属多个岗位可更换岗位</div>
							</div>
							<div class="personal-edit-safe-item-right">
...
import {useI18n} from "vue-i18n";
	...
	onMounted(() => {
		...
		state.roleId = store.state.userInfos.userInfos.roleId;
		state.postId = store.state.userInfos.userInfos.postId;
	})
