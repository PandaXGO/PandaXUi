<template>
    <div class="app-container">
        ...
        <el-dialog title="测试发送邮件" v-model="debugOpen" width="769px" center>
            <el-form label-width="80px" :model="debugForm" :rules="debugRules" ref="debugFormRef">
                <el-form-item label="邮箱编号">
                    <el-input v-model="debugForm.mailId" :disabled="true"/>
                </el-form-item>
                <el-form-item label="联系人">
                    <el-input placeholder="请输入要发送给谁" v-model="debugForm.to"/>
                </el-form-item>
                <el-form-item label="发送主题">
                    <el-input placeholder="请输入发送主题" v-model="debugForm.subject"/>
                </el-form-item>
                <el-form-item label="发送内容">
                    <el-input type="textarea" placeholder="请输入发送内容" v-model="debugForm.body"/>
                </el-form-item>
            </el-form>
            <template #footer>
    ...
    export default {
        ...
        setup() {
            ...
            const submitDebug = () => {
                ...
                if (!formWrap) return;
                formWrap.validate((valid: boolean) => {if (valid) {
